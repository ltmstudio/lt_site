...
export default function Footer() {
  return (
    <footer className="h-[10%] border-t-3  border-black-500   shrink-0 sticky bottom-0   px-4 py-6 flex flex-col md:flex-row justify-between items-start gap-4 ">
      <div className="basis-4/12 flex-col  flex  gap-3 items-left justify-center">
        <a
          className="cursor-alias flex items-center  hover:underline hover:underline-offset-4"
      ...
      <div className="basis-8/12 flex justify-end">
        <div className="flex  flex gap-1 items-center justify-center">
          {contactInfo.map((item, index) => (
            <a
              key={index}
              className="flex items-center hover:underline hover:underline-offset-4 text-left w-full"
              href={item.link}
            >
