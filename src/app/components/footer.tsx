...
export default function Footer({ isAnimating }: { isAnimating: boolean }) {
  return (
    ...
    >
      <div className="logoFooter basis-4/12 lg:basis-4/12 md:w-full sm:w-full flex-col flex order-second lg:order-first md:order-last sm:order-last gap-3 items-center lg:items-start md:items-center sm:items-center ">
        <a
      ...
      <div className=" basis-8/12 lg:basis-8/12 md:w-full sm:w-full flex order-first lg:order-second md:order-first sm:order-first justify-end">
